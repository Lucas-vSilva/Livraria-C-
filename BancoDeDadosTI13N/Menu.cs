            ...
            do
            {
                ...
                switch (opcao)
                {
                    case 1:
                        ...
                        dao.Inserir(cpf, nome, dataDeNascimento, telefone, endereco, enderecoEmail, login, senha);
                        break;
                    case 2:
                        //Consultar os dados
                    ...
                    case 3:
                        ...
                        Console.WriteLine("Nome: " + dao.ConsultarNome(codigo) +
                                          "\nData de Nascimento: " + dao.ConsultarData(codigo) +
                                          "\nTelefone: " + dao.ConsultarTelefone(codigo) +
                                          "\nEndereço: " + dao.ConsultarEndereco(codigo) +
                                          "\nEndereço E-mail: " + dao.ConsultarEnderecoEmail(codigo) +
